...
- Added three new metrics:
	...
	- Relative economic value from rates: `scores.continuous.relative_economic_value_from_rates`, `scores.probability.relative_economic_value_from_rates` , `scores.categorical.relative_economic_value_from_rates` and `scores.plotdata.relative_economic_value_from_rates`. See [PR #999](https://github.com/nci/scores/pull/999) and [PR #1088](https://github.com/nci/scores/pull/1088).
