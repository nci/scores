...
class FssNumpy(FssBackend):
    ...
    def _compute_integral_field(self):  # pylint: disable=too-many-locals
        ...
        # pad first row/column with 0s, addresses off-by-one window sizes for the first row/column
        ...
        self._obs_img = (obs_d - obs_b - obs_c + obs_a) / (self.window_size[0] * self.window_size[1])
        ...
        self._fcst_img = (fcst_d - fcst_b - fcst_c + fcst_a) / (self.window_size[0] * self.window_size[1])
