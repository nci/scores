...
def comparative_discretise(
    ...
    *,
    ...
    Examples:
        ...
        Coordinates:
          * station    (station) <U1 12B 'A' 'B' 'C'
          * threshold  (threshold) int64 24B 15 20 25
        Attributes:
            discretisation_tolerance:  0
            discretisation_mode:       >=
    ...
    if mode in INEQUALITY_MODES:
        ...
        operator_func = EQUALITY_MODES[mode]  # type: ignore[index]
    ...
    *,  # Force keywords arguments to be keyword-only
    ...
    Examples:
        ...
        array([[0., 0., 0.],
               ...
               [1., 1., 1.]])
        Coordinates:
          * station    (station) <U1 16B 'A' 'B' 'C' 'D'
          * threshold  (threshold) int64 24B 15 20 25
        Attributes:
            discretisation_tolerance:  0
            discretisation_mode:       >=
        ...
        Coordinates:
          * station    (station) <U1 16B 'A' 'B' 'C' 'D'
          * threshold  (threshold) int64 8B 25
        Attributes:
            discretisation_tolerance:  0
            discretisation_mode:       <=
...
def binary_discretise_proportion(
    ...
    *,  # Force keywords arguments to be keyword-only
    ...
    Examples:
        ...
        array([0.25, 0.5 , 0.25])
        Coordinates:
          * threshold  (threshold) float64 24B 0.0 0.5 1.0
        Attributes:
            discretisation_tolerance:  0
        ...
        Attributes:
            discretisation_tolerance:  0
            discretisation_mode:       <built-in function ge>
